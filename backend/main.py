...
CRITICAL (95+ risk): Multiple uncontrolled variables (no pilot, large cohort, unverified reagents, inconsistent procedures).
HIGH (70-90 risk): Significant issues in reagent sourcing, storage stability, or protocol consistency.
MEDIUM (40-60 risk): Minor issues or good protocols with 1-2 small gaps.
LOW (10-30 risk): Well-designed protocol with proper controls, pilots, and verification.

Analyze for: reagent purity/sourcing, storage stability, pilot testing, sample size, fasting/timing consistency, equipment calibration, local supplier variability.
...
Be specific, direct, and actionable. Reply in 2-3 sentences max. No markdown, no generic advice."""
...
def ollama_generate(
    ...
    *,
    ...
    logger.info("ollama_generate raw_response=%r", raw[:RAW_LOG_PREVIEW_CHARS])
